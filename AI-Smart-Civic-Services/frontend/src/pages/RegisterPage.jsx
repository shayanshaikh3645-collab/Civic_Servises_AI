...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const loginResponse = await api.post('/auth/token', new URLSearchParams({ username: email, password }).toString(), {
  ...
  return (
    <div className="mx-auto max-w-xl rounded-xl bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-slate-600">Create an account to submit complaints and track service response.</p>
